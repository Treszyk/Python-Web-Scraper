...
class Scraper:
    ...
    def scrape_opinions(self, id:str) -> tuple:
        reviews = []
        product_info = {}
        #first page + number of reviews + product_info
        ...
        if soup.find('div', class_='error-page') or soup.find('h1', {"title" : "Błąd 500"}, class_='title'):
            print(soup.find('div', class_='error-page'))
            print(soup.find('h1', class_='title'))
            print('tutaj bledy')
    ...
    def extract_details(self, opinion) -> Opinion:
        ...
        #print('AMOGUS', id.strip(), author.strip(), 35)
        print('amogus', plus, minus)            
